...
**Important:** Create a `.env.local` file in the `web/` directory with:
```env
NEXT_PUBLIC_API_URL=http://localhost:4000
```
...
- **Vercel (Frontend) + Render (Backend)** - Recommended for beginners
- **Railway** - Full stack deployment
- **AWS/DigitalOcean** - Advanced self-hosted
